    ...
    <div class="body">
        <section>
            <div class="tabla">
                <?php
                    if($adopciones >= 2 ) {
                        echo "<h1>NO PUEDES ADOPTAR MAS DE DOS MASCOTAS...</h1>";
                        echo
                                "<script>
                                    setTimeout(function () {
                        ...
                        $query = mysqli_query($link,"select * from mascotas where adoptado=0 order by tipo,raza");
                        if($query->num_rows > 0) {
                            echo 
                            ...
                            while($row=mysqli_fetch_array($query)) {
                                ...
                                echo 
                                        "<div class='fila'>
                                            ...
                                            <div class='celda'><p>$edad</p></div>
                                            <div class='celda'><p>$descripcion</p></div>
                                            <div class='celda'><a href='adoptarok.php?a=$adopciones&u=$id_user&m=$id'><p>ADOPTAR</p></a></div>
                                        </div>";
                            }
